...
dataset_train = pd.read_csv('train/train.csv')
X_train = dataset_train.iloc[:, 0:1573].values
print X_train
...
y_train = dataset_train.iloc[:, 1573:1574].values
print y_train.shape
print y_train
enc = OneHotEncoder()
enc.fit(y_train)  
...
train_x = train_x.reshape((train_x.shape[0], 1573, 1))
test_x = test_x.reshape((test_x.shape[0], 1573, 1))
# print train_x
# print train_y.shape
# print train_y
