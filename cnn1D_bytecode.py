...
dataset_train = pd.read_csv('train/train_byte_code.csv')
X_train = dataset_train.iloc[:, 0:534].values
print X_train.shape
...
y_train = dataset_train.iloc[:, 534:535].values
print y_train.shape
print y_train
enc = OneHotEncoder()
enc.fit(y_train)  
...
train_x = train_x.reshape((train_x.shape[0], 534, 1))
test_x = test_x.reshape((test_x.shape[0], 534, 1))
# print train_x
# print train_y.shape
# print train_y
...
dataset_test = pd.read_csv('test/test_byte_code.csv')
X_test = dataset_test.iloc[:, 0:534].values
X_test = StandardScaler().fit_transform(X_test)
X_test = X_test.reshape((X_test.shape[0], 534, 1))
